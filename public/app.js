...
async function loadCities() {
  ...
  try {
    ...
    if (filterState.continent) params.set('continent', filterState.continent);
    if (filterState.max_budget) params.set('max_budget', filterState.max_budget);
    if (filterState.min_safety) params.set('min_safety', filterState.min_safety);
    if (filterState.min_affordability) params.set('min_affordability', filterState.min_affordability);
    if (filterState.digital_nomad) params.set('digital_nomad', 'true');
